...
def bin_ext_euclid(a, b):
    # u <- a, v <- b
    # d = gcd(a, b) & binary polynomials g, h satisfying ag + bh = d
    # g_1 <- 1, g_2 <- 0 / h_1 <- 0, h_2 <- 1
    u, v = a, b

    # 1st loop invariant,  2nd loop invariant
    g_1, g_2 = 1, 0
    h_1, h_2 = 0, 1
...
if __name__ == "__main__":
   ...
   # print("deg(0b100011011) = {}".format(deg(0b100011011)))
